...
export default async function Page({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="w-screen flex flex-wrap gap-6 bg-slate-200 py-10 px-8">
      ...
      <p>State Head: {stateHeadsData?.name ? stateHeadsData?.name : "N/A"},</p>
      <p>Zonal Head: {zonalHeadsData?.name ? zonalHeadsData?.name : "N/A"},</p>
      ...
      <p>Proposal Sent : {lead?.proposalSent ? lead?.proposalSent : "N/A"},</p>
      <p>Demo Done : {lead?.demoDone ? lead?.demoDone : "N/A"},</p>
      <p>
        Interested In Sm : {lead?.interestedInSm ? lead?.interestedInSm : "N/A"}
        ,
      </p>
      <p>Tid Generated : {lead?.TidGenerated ? lead?.TidGenerated : "N/A"},</p>
      <p>
      ...
      <p>Training Done : {lead?.trainingDone ? lead?.trainingDone : "N/A"},</p>
